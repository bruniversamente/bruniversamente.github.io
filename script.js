...
const translations = {
  pt: {
    ...
    texts: {
      ...
      ".query-card small": "pergunta",
      ".query-card p": "Onde a margem cai antes da receita parecer um problema?",
      ".kpi-card.accent small": "cases",
      ".kpi-card.accent span": "end-to-end",
      ".kpi-card:not(.accent) small": "stack",
      ".kpi-card:not(.accent) span": "DuckDB + Power BI",
      ".chart-head span": "qualidade dos dados",
      ".signal-card p": "Disponível para oportunidades em Dados, BI, MIS, Produto e IA aplicada.",
    ...
    attrs: {
      ...
      ".hero-lab": { "aria-label": "Resumo visual de projetos de dados" },
  ...
  en: {
    ...
    texts: {
      ...
      ".query-card small": "question",
      ".query-card p": "Where does margin fall before revenue starts looking like a problem?",
      ".kpi-card.accent small": "cases",
      ".kpi-card.accent span": "end-to-end",
      ".kpi-card:not(.accent) small": "stack",
      ".kpi-card:not(.accent) span": "DuckDB + Power BI",
      ".chart-head span": "data quality",
      ".signal-card p": "Available for opportunities in Data, BI, MIS, Product and applied AI.",
    ...
    attrs: {
      ...
      ".hero-lab": { "aria-label": "Visual summary of data projects" },
  ...
  es: {
    ...
    texts: {
      ...
      ".query-card small": "pregunta",
      ".query-card p": "¿Dónde cae el margen antes de que los ingresos parezcan un problema?",
      ".kpi-card.accent small": "casos",
      ".kpi-card.accent span": "end-to-end",
      ".kpi-card:not(.accent) small": "stack",
      ".kpi-card:not(.accent) span": "DuckDB + Power BI",
      ".chart-head span": "calidad de datos",
      ".signal-card p": "Disponible para oportunidades en Datos, BI, MIS, Producto e IA aplicada.",
    ...
    attrs: {
      ...
      ".hero-lab": { "aria-label": "Resumen visual de proyectos de datos" },
